...
- {id: FLEXSPI_CLK_ROOT.outFreq, value: 133 MHz}
...
- {id: TRACE_CLK_ROOT.outFreq, value: 99.75 MHz}
- {id: UART_CLK_ROOT.outFreq, value: 80 MHz}
- {id: USDHC1_CLK_ROOT.outFreq, value: 106.4 MHz}
- {id: USDHC2_CLK_ROOT.outFreq, value: 106.4 MHz}
settings:
...
- {id: CCM_ANALOG.PLL2.denom, value: '6', locked: true}
- {id: CCM_ANALOG.PLL2.div, value: '22', locked: true}
- {id: CCM_ANALOG.PLL2.num, value: '1', locked: true}
...
const clock_sys_pll_config_t sysPllConfig_BOARD_BootClockRUN =
    {
        ...
        .denominator = 6,                         /* 30 bit denominator of fractional loop divider */
        .src = 0,                                 /* Bypass clock source, 0 - OSC 24M, 1 - CLK1_P and CLK1_N */
    };
